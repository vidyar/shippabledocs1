# -*- coding: utf-8 -*-
#
# shippable documentation build configuration file, created by
...
# Configure extlinks
extlinks = { 'issue': ('https://github.com/shippable/docs/issues/%s',
	               'Issue ') }
...
project = u'Shippable'
copyright = u'2014 Shippable, Inc.'
...
htmlhelp_basename = 'Shippabledoc'
...
#latex_documents = [
#  ('toctree', 'shippable.tex', u'shippable Documentation',
#   u'Team shippable', 'manual'),
#]
...
#man_pages = [
#    ('reference/commandline/cli', 'shippable', u'shippable CLI Documentation',
#     [u'Team shippable'], 1),
...
texinfo_documents = [
  ('toctree', 'Shippable', u'Shippable Documentation',
   u'Team Shippable', 'Shippable', 'One line description of project.',
   'Miscellaneous'),
]
